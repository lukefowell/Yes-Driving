...
<?php } ?>
<?php if($dates_opt_val=='checked') { ?><span class="tickerDate"><?php echo $date; ?></span> - <?php } ?><span class="tickerLink"><?php echo $title;?></span><?php if($content_opt_val=='checked') { ?> - <span class="tickerText"><?php echo $excerpt; ?>... <a href="<?php echo $link; ?>">More &rarr;</a></span><?php } ?></li>
...
tr.gre {
  ...
  <form name="form1" method="post" action="<?php echo str_replace( '%7E', '~', $_SERVER['REQUEST_URI']); ?>">
    ...
    <table class="form-table">
        ...
        <tr class="gre" valign="top" style="display:none;">
  ...
  if($phpmaj<PHPREQ){?>
        ...
        <input class="ruler" type="hidden" name="<?php echo $rss_opt_name; ?>" value='norss' <?php if($rss_opt_val=='norss'){echo 'checked';} ?> >
